...
const Services = () => {
  ...
  return (
    <div className="flex-col w-full justify-center items-center gradient-bg-services">
      <div className="flex mf: fle items-center justify-between md:p-20 py-12 px-4">
